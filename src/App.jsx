          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-20 mb-12">
            ...
            <div className="md:w-1/3 space-y-4">
              <div className="flex items-center gap-3">
                 ...
                 <div><h3 className="text-white font-bold text-base tracking-wider">TUCASA CBE</h3><p className="text-[10px] text-slate-500 uppercase tracking-widest">Dar es Salaam</p></div>
              </div>
            ...
            <div className="md:w-2/3 grid grid-cols-2 gap-8 md:gap-12">
              ...
              <div>
                ...
                <ul className="space-y-3 text-xs md:text-sm">
                  <li className="flex items-start gap-2"><MapPin size={16} className="text-blue-500 shrink-0 mt-0.5" /><span>CBE Dar Campus,<br/>Bibi Titi Mohamed Rd.</span></li>
                  <li className="flex items-center gap-2"><Phone size={16} className="text-blue-500 shrink-0" /><span className="font-mono">{contactInfo.phone}</span></li>
